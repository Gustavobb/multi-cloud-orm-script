...
class AwsConnection:
    ...
    def create_security_group(self, security_group_name, permissions):
        ...
        try:
            vpc_id = self.ec2_client.describe_vpcs().get('Vpcs', [{}])[0].get('VpcId', '')
    ...
    def delete_instances(self):
        ...
        try:
          ...
          if len(instance_id['Reservations']) != 0:
...
def run_application() -> int:
     ...
     # tags
     # -> keys
     key_tag_nv = {'Key': 'Name', 'Value': 'key_braga_pf_nv'}
     key_tag_oh = {'Key': 'Name', 'Value': 'key_braga_pf_oh'}

     # -> security-groups
     security_group_tag = {'Key': 'Name', 'Value': 'security_group_braga_pf'}

     # -> instances
     instance_tag_nv = {'Key': 'Name', 'Value': 'instance_braga_pf_nv'}
     instance_tag_oh = {'Key': 'Name', 'Value': 'instance_braga_pf_oh'}
